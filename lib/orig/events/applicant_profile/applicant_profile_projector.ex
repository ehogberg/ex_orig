defmodule Orig.Events.ApplicantProfile.ApplicantProfileProjector do
  ...
  project %ApplicantProfileChanged{applicant_profile: new_profile, persistence: "create"}, fn multi ->
    cs = ApplicantProfile.changeset(%ApplicantProfile{}, new_profile)
    Multi.insert(multi, :applicant_profiles, cs)
  end

  project %ApplicantProfileChanged{applicant_profile: changed_profile, persistence: "update",
    app_id: app_id}, fn multi ->
      cs = ApplicantProfile
